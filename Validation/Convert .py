...
# Đọc file CSV
csv_file = "/Users/mac/Creative Cloud Files/Python Project/Diagnosis_Xray/VINAI_Chest_Xray/train_downsampled.csv"
    ...
    if file[0] != ".":  # Ignore temp file
        ...
        if len(df_find) > 0:
            ...
            for index, row in df_find.iterrows():
                ...
                labels.append([row[2], box_center_x_normalized, box_center_y_normalized, box_width_normalized,
